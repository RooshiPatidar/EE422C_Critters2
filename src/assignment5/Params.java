...
public class Params {
	...
	public static int look_energy_cost = 2;
...
/*
	...
	public static int walk_energy_cost = 2;
	public static int run_energy_cost = 5;
	public static int rest_energy_cost = 5;
	public static int min_reproduce_energy = 20;
	public static int refresh_algae_count = 1;
	public static int photosynthesis_energy_amount = 0;
